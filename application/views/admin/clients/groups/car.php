...
<?php     
  ...
  $table_data     = array_merge($table_data, [_l('brand'), _l('model'), _l('model_year'), _l('plate_source'), _l('plate_code'),_l('plate_number')]);
   $custom_fields = get_custom_fields('cars', ['show_on_table' => 1]);
