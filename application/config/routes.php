...
/**
 * @since 2.3.0
 * Routes for admin/lang URL because lang.php class is used in application/third_party/MX
 */
// $route['admin/lang_upload']        = 'admin/mods/lang_upload';
// $route['admin/lang_upload/(:any)']        = 'admin/mods/upload_languages';
// $route['admin/languages/changeline']        = 'admin/mods/upload_languages';
